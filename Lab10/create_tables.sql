...
insert into FACULTY   (FACULTY,   FACULTY_NAME )
            values  ('мегатест',     'Технология органических веществ');

--------------------------------------------------------------------------------------------
-- DROP TABLE PULPIT
CREATE TABLE PULPIT 
(
 PULPIT       CHAR(10 char)      NOT NULL,
 PULPIT_NAME  VARCHAR2(100 char), 
 FACULTY      CHAR(10 char)      NOT NULL, 
...
(
  AUDITORIUM_TYPE   char(10 char) constraint AUDITORIUM_TYPE_PK  primary key,  
  AUDITORIUM_TYPENAME  varchar2(30 char) constraint AUDITORIUM_TYPENAME_NOT_NULL not null         
);
...
(
 AUDITORIUM           char(10 char) primary key,  -- код аудитории
 AUDITORIUM_NAME      varchar2(200 char),          -- аудитория 
 AUDITORIUM_CAPACITY  number(4),              -- вместимость
 AUDITORIUM_TYPE      char(10 char) not null      -- тип аудитории
