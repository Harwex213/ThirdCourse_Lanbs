...
int main(int argc, char* argv[])
{
	...
	{
		if (argc != 7) {
			throw std::exception("Wrong process arguments. Should be fileName(char*), loggerName(char*), secSnapshotInteval, capacity, maxKeyLength, maxPayloadLength");
		}
		...
		CreateComponentApi::CreateStorage(pComponent, params[1], params[0], params[2], params[3], fileName);
