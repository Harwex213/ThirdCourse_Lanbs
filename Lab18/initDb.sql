...
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY )
  values  (N'ИСиТ', N'Информационных систем и технологий N' ,N'ИТ'  )
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY )
values  (N'ПОиСОИ' ,N'Полиграфического оборудования и систем обработки информации N', N'ИДиП'  )
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY )
  values  (N'БФ', N'Белорусской филологии' ,N'ИДиП'  )
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY )
   values  (N'РИТ', N'Редакционно-издательских тенологий', N'ИДиП'  )            
insert into PULPIT   (PULPIT,  PULPIT_NAME, FACULTY )
   values  (N'ПП', N'Полиграфических производств' ,N'ИДиП'  )                              
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY)
...
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY)
 values  (N'ТНВиОХТ' ,N'Технологии неорганических веществ и общей химической технологии N' ,N'ХТиТ') 
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY)
...
insert into  TEACHER    (TEACHER,  TEACHER_NAME, GENDER, PULPIT )
                       values  (N'РЖК',   N'Рожков Леонид Николаевич N', N'м', N'ЛВ');                      
insert into  TEACHER    (TEACHER,  TEACHER_NAME, GENDER, PULPIT )
...
insert into GROUPS   (FACULTY,  PROFESSION, YEAR_FIRST )
         values (N'ИТ','1-40 01 02', 2013), --1
                (N'ИТ',N'1-40 01 02', 2012),
                (N'ИТ',N'1-40 01 02', 2011),
                (N'ИТ',N'1-40 01 02', 2010),
                (N'ИТ',N'1-36 06 01', 2010),-----8 гр
                (N'ИТ',N'1-36 06 01', 2013),
                (N'ИТ',N'1-36 06 01', 2012),
                (N'ИТ',N'1-36 06 01', 2011),
...
insert into STUDENT (IDGROUP, NAME, BDAY)
        values (1, N'Хартанович Екатерина Александровна', N'11.03.1995'),        
          (1, N'Горбач Елизавета Юрьевна',    N'07.12.1995'),
           (1, N'Зыкова Кристина Дмитриевна',  N'12.10.1995'),
           (1, N'Шенец Екатерина Сергеевна',   N'08.01.1995'),
           (1, N'Шитик Алина Игоревна',  N'02.08.1995')       
insert into STUDENT (IDGROUP,NAME, BDAY)
...
insert into PROGRESS (SUBJECT, IDSTUDENT, PDATE, NOTE)
    values (N'ОАиП', 1000,  N'01.10.2013',6),
           (N'ОАиП', 1001,  N'01.10.2013',8),
